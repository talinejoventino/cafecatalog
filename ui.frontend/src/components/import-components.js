...
const CoffeeCard = withAsyncImport(() => import(`./CoffeeCard/CoffeeCard`));
...
MapTo('cafecatalog/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('cafecatalog/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('cafecatalog/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('cafecatalog/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('cafecatalog/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('cafecatalog/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('cafecatalog/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});
...
MapTo('cafecatalog/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
